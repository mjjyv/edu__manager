-- Lưu ý: Nếu bảng của bạn tên là 'user', hãy để trong dấu ngoặc kép "user" vì 'user' là từ khóa hệ thống của PostgreSQL.
INSERT INTO users (ten_dang_nhap, mat_khau, vai_tro) 
